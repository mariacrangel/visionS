...
#include "../src/onfivc/devicesearcher.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__DeviceSearcher_t, stringdata0) + ofs \
...
void *ONVIF::DeviceSearcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__DeviceSearcher.stringdata0))

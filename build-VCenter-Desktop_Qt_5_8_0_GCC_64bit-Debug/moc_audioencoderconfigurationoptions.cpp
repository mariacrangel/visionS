...
#include "../src/onfivc/media_management/audioencoderconfigurationoptions.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__AudioEncoderConfigurationOptions_t, stringdata0) + ofs \
...
void *ONVIF::AudioEncoderConfigurationOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__AudioEncoderConfigurationOptions.stringdata0))

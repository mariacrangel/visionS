...
void Manual::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_list_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
...
const QMetaObject Manual::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Manual.data,
      qt_meta_data_Manual,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};

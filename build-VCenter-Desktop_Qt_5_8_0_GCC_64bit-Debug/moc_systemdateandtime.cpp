...
#include "../src/onfivc/device_management/systemdateandtime.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__SystemDateAndTime_t, stringdata0) + ofs \
...
void ONVIF::SystemDateAndTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< DateTimeType*>(_v) = _t->dateTimeType(); break;
        case 1: *reinterpret_cast< bool*>(_v) = _t->daylightSavings(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->tz(); break;
        case 3: *reinterpret_cast< QDateTime*>(_v) = _t->utcTime(); break;
        case 4: *reinterpret_cast< QDateTime*>(_v) = _t->localTime(); break;
        case 5: *reinterpret_cast< bool*>(_v) = _t->result(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setDateTimeType(*reinterpret_cast< DateTimeType*>(_v)); break;
        case 1: _t->setDaylightSavings(*reinterpret_cast< bool*>(_v)); break;
        case 2: _t->setTz(*reinterpret_cast< QString*>(_v)); break;
        case 3: _t->setutcTime(*reinterpret_cast< QDateTime*>(_v)); break;
        case 4: _t->setlocalTime(*reinterpret_cast< QDateTime*>(_v)); break;
        case 5: _t->setResult(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
void *ONVIF::SystemDateAndTime::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__SystemDateAndTime.stringdata0))

...
QT_MOC_LITERAL(1, 9, 7), // "newDate"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 17), // "on_accept_clicked"
QT_MOC_LITERAL(4, 36, 17) // "on_cancel_clicked"

    },
    "Calendar\0newDate\0\0on_accept_clicked\0"
    "on_cancel_clicked"
};
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDate((*reinterpret_cast< QDate(*)>(_a[1]))); break;
        ...
        {
            typedef void (Calendar::*_t)(QDate );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Calendar::newDate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Calendar::newDate(QDate _t1)
{

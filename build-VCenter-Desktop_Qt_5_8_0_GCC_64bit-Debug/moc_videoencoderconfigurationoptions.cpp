...
#include "../src/onfivc/media_management/videoencoderconfigurationoptions.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__VideoEncoderConfigurationOptions_t, stringdata0) + ofs \
...
void *ONVIF::VideoEncoderConfigurationOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__VideoEncoderConfigurationOptions.stringdata0))

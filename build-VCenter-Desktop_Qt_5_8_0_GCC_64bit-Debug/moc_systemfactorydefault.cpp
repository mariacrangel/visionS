...
#include "../src/onfivc/device_management/systemfactorydefault.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__SystemFactoryDefault_t, stringdata0) + ofs \
...
void ONVIF::SystemFactoryDefault::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< FactoryDefault*>(_v) = _t->factoryDefault(); break;
        case 1: *reinterpret_cast< bool*>(_v) = _t->result(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setFactoryDefault(*reinterpret_cast< FactoryDefault*>(_v)); break;
        case 1: _t->setResult(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
void *ONVIF::SystemFactoryDefault::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__SystemFactoryDefault.stringdata0))

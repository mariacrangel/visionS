                    ...
                    persist_(nullptr), userCallback_(nullptr)
{
    MQTTAsync_create(&cli_, const_cast<char*>(serverURI.c_str()),
                     ...
                     MQTTCLIENT_PERSISTENCE_NONE, nullptr); //Was MQTTCLIENT_PERSISTENCE_DEFAULT. venturamartin90.
}
                                     ...
                                     MQTTAsync_message* msg)
{
    ...
    // TDO: Should the user code determine the return value?

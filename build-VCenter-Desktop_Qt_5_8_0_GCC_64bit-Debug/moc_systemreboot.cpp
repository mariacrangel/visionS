...
#include "../src/onfivc/device_management/systemreboot.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__SystemReboot_t, stringdata0) + ofs \
...
void *ONVIF::SystemReboot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__SystemReboot.stringdata0))

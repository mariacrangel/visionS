...
#include "../src/onfivc/device_management/user.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__Users_t, stringdata0) + ofs \
...
void ONVIF::Users::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: *reinterpret_cast< UserLevelType*>(_v) = _t->userLevel(); break;
        default: break;
        }
        ...
        case 2: _t->setUserLevel(*reinterpret_cast< UserLevelType*>(_v)); break;
        default: break;
        }
...
void *ONVIF::Users::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__Users.stringdata0))
